...
namespace RoslynDom.CSharp
{
    public class RDomEnumMemberMiscFactory
       : RDomBaseSyntaxNodeFactory<RDomEnumMember, EnumMemberDeclarationSyntax>
    {
        ...
        public override IEnumerable<SyntaxNode> BuildSyntax(IDom item)
        {
            ...
            {
                if (itemAsT.Expression.InitialExpressionLanguage != ExpectedLanguages.CSharp) { throw new InvalidOperationException(); }
